...
fun DescriptorRenderer.asRenderer() = ContextDependentRenderer<DeclarationDescriptor> {
    desc, context ->
    val adaptiveRenderer = this.withOptions {
        nameShortness = context.adaptiveNameShortness
    }
    adaptiveRenderer.render(desc)
}