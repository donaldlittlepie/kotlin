...
object OverloadUtil {
    ...
    private object OverloadabilitySpecificityCallbacks : SpecificityComparisonCallbacks<CallableDescriptor> {
        override fun isSignatureNotLessSpecific(signature1: FlatSignature<CallableDescriptor>, signature2: FlatSignature<CallableDescriptor>): Boolean? =
                null
